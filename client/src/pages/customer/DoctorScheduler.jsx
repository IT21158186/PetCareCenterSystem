                ...
                <div className="grid grid-cols-8 gap-2">
                    ...
                    {timeSlots.map((timeSlot, index) => (
                        <React.Fragment key={index}>
                            ...
                            <div className="text-center col-span-1 border p-2">{getAppointmentStatus("Monday", timeSlot)}</div>
                            <div className="text-center col-span-1 border p-2">{getAppointmentStatus("Tuesday", timeSlot)}</div>
                            <div className="text-center col-span-1 border p-2">{getAppointmentStatus("Wednesday", timeSlot)}</div>
                            <div className="text-center col-span-1 border p-2">{getAppointmentStatus("Thursday", timeSlot)}</div>
                            <div className="text-center col-span-1 border p-2">{getAppointmentStatus("Friday", timeSlot)}</div>
                            <div className="text-center col-span-1 border p-2">{getAppointmentStatus("Saturday", timeSlot)}</div>
                            <div className="text-center col-span-1 border p-2">{getAppointmentStatus("Sunday", timeSlot)}</div>
                        </React.Fragment>
                    ))}
                </div>
            </div>
